...
export ESHELL=bash
export PAGER=less
export PATH=$PATH:$HOME/.local/bin:$HOME/bin:$HOME/usr/bin:/usr/sbin:/usr/local/sbin:$GOPATH/bin:$HOME/.cask/bin:$HOME/.jenv/bin
...
for ext in c el go groovy html java json js pl pm py rb sh sql ts txt xml yml yaml; do
